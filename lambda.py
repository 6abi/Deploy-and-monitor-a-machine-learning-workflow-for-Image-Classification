...
"""
### 1° lambda_function: data serialization
...
{
  "image_data": "",
  "s3_bucket": "sagemaker-us-east-1-513508352252",
...
# function 2
### 2° lambda_function: image classification
...
ENDPOINT = "image-classification-2022-02-14-19-20-14-783"
...
def lambda_handler(event, context):
    ...
    # For this model the IdentitySerializer needs to be "image/png, done in 'ContentType' "
...
### 3° lambda_function: filter low confidence inferences
